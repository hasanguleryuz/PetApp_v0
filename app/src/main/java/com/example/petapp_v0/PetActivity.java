...
public class PetActivity extends AppCompatActivity {
    ...
    TextView tv_petName, tv_petGenus, tv_petGendre, tv_petBirthyear;
    EditText et_vaccineType, et_vaccineDate;
    //RadioGroup rg_vaccineStaus;
    String s_petName, s_petGenus, s_petBirthyear, s_petGender, s_vaccineDate, s_vaccineStatus, s_vaccineType;
    ListView lv_vaccineList;
    Button btn_addVaccine;
    int position;
